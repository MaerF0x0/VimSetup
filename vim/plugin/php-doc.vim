...
let g:pdv_cfg_ExceptionVal = "Istock_ _Exception"
...
func! PhpDocFunc()
	...
	exe l:txtBOL . g:pdv_cfg_Comment1 . "Function description goes here" . g:pdv_cfg_EOL
	...
	exe l:txtBOL . g:pdv_cfg_Commentn . "@throws " . g:pdv_cfg_ExceptionVal . g:pdv_cfg_EOL
